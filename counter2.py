...
pygame.display.set_caption("Cosmic Clocks: Co-Domain Attractor Mechanism")
...
while running:
    ...
    caption = font.render("Earth: N=365 ≈ Y=365.2422, E mod Y ≈ 120.9614", True, WHITE)
    screen.blit(caption, (10, height - 180))
    caption2 = font.render("yields shared scalar 6585.3.", True, WHITE)
    screen.blit(caption2, (10, height - 150))
    caption3 = font.render("Counterfactual: N=51 ≠ Y=510, E mod Y = 410", True, WHITE)
    screen.blit(caption3, (10, height - 120))
    caption4 = font.render("breaks scalar at 500.", True, WHITE)
    screen.blit(caption4, (10, height - 90))
    caption5 = small_font.render("Note: Earth’s N physically determined.", True, WHITE)
    screen.blit(caption5, (10, height - 60))
    caption6 = small_font.render("Attractor not universal.", True, WHITE)
