...
pygame.display.set_caption("Cosmic Clock: 6585.3 Harmonic Frequency")
clock = pygame.time.Clock()

# Colors
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
SILVER = (192, 192, 192)  # Lunar rhythm (Saros)
GOLD = (255, 215, 0)      # Earth-solar rhythm (year)
GLOW = (255, 100, 100)    # Pulsating alignment highlight
...
LONG_TERM_CYCLE = 6585.3 * SOLAR_YEAR  # Days in 6585.3 years (harmonic sync)
...
trail_saros = []
trail_year = []
glow_alpha = 0  # For pulsating glow
...
while running:
    ...
    # Draw year hand (Earth-solar rhythm)
    ...
    caption = font.render("6585.3: Closest frequency syncing lunar and solar-lunar cycles", True, WHITE)
