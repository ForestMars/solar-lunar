...
pygame.display.set_caption("Cosmic Clocks: Modular Relationship")
...
while running:
    ...
    caption = font.render("Earth: N=365 ≈ Y=365.2422, Y/(E mod Y) ≈ 3.0197", True, WHITE)
    screen.blit(caption, (10, height - 180))
    caption2 = font.render("from Moon’s periods, yields 6585.3 scalar.", True, WHITE)
    screen.blit(caption2, (10, height - 150))
    caption3 = font.render("Counterfactual: N=51 ≠ Y=510, Y/(E mod Y) ≈ 1.2439", True, WHITE)
    screen.blit(caption3, (10, height - 120))
    caption4 = font.render("breaks scalar at 500.", True, WHITE)
    screen.blit(caption4, (10, height - 90))
    caption5 = small_font.render("Note: Earth’s scalar physically determined.", True, WHITE)
    screen.blit(caption5, (10, height - 60))
    caption6 = small_font.render("Other systems may align.", True, WHITE)
