...
pygame.display.set_caption("Cosmic Clocks: Why N Converges")
...
while running:
    ...
    caption2 = font.render("from Moon’s periods and Earth’s year.", True, WHITE)
    ...
    caption4 = font.render("from different periods.", True, WHITE)
    screen.blit(caption4, (10, height - 90))
    caption5 = small_font.render("Note: N determined by modular ratio.", True, WHITE)
    screen.blit(caption5, (10, height - 60))
    caption6 = small_font.render("Convergence system-specific.", True, WHITE)
