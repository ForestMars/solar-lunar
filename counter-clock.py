# counter-clock_.py - Counterfactual clock visualization showing scaling unit trick is not universal.
...
pygame.display.set_caption("Cosmic Clocks: 6585.3 vs. the Counterfactual")
...
while running:
    ...
    caption = font.render("Earth: 6585.3 days (Saros) = 6585.3 years, because", True, WHITE)
    screen.blit(caption, (10, height - 180))
    caption2 = font.render("365 counts and converts, a lucky cosmic trick", True, WHITE)
    screen.blit(caption2, (10, height - 150))
    caption3 = font.render("Counterfactual: 5000 days ≠ 500 years when year", True, WHITE)
    screen.blit(caption3, (10, height - 120))
    caption4 = font.render("shifts to 510 sols, math’s fragile harmony breaks", True, WHITE)
    screen.blit(caption4, (10, height - 90))
    caption5 = small_font.render("*Saros is divine, but not universal—tweak the", True, WHITE)
    screen.blit(caption5, (10, height - 60))
    caption6 = small_font.render("year, and the scalar splits", True, WHITE)
