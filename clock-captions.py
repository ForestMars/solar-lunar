# clock-captions.py - Orbital clock with updated captions.
...
pygame.display.set_caption("Cosmic Clock: 6585.3, the Universe’s Wink")
clock = pygame.time.Clock()

# Colors
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
SILVER = (192, 192, 192)  # Lunar Saros, slow and dreamy
GOLD = (255, 215, 0)      # Earth-solar year, frenetic
GLOW = (255, 100, 100)    # Near-miss resonance glow

# Clock parameters
center = (width // 2, height // 2)
radius = 250
font = pygame.font.SysFont("arial", 16)
small_font = pygame.font.SysFont("arial", 14)  # For DFW-style asides
...
while running:
    ...
    caption = font.render("6585.3 days (Saros) = 6585.3 years (solar-lunar), because", True, WHITE)
    screen.blit(caption, (10, height - 150))
    caption2 = font.render("365 counts cycles and converts days to years, a cosmic trick", True, WHITE)
    screen.blit(caption2, (10, height - 120))
    caption3 = font.render("half Earth’s doing, half the universe’s near-miss harmony", True, WHITE)
    screen.blit(caption3, (10, height - 90))
    caption4 = small_font.render("*Why 365? It’s like the universe knows we’re watching", True, WHITE)
    screen.blit(caption4, (10, height - 60))
    caption5 = font.render("Rooted in Earth’s spins and orbits", True, WHITE)
    screen.blit(caption5, (10, height - 30))
